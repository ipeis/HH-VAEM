...
class HMCVAEM(HMCVAE):
    """
    Implements a Hamiltonian VAEM (HMC-VAEM) as described in https://arxiv.org/abs/2202.04599
    ...
    def __init__(self, 
        ...
        super(HMCVAEM, self).__init__(dataset=dataset, dim_x=dim_x, dim_y=dim_y, 
            ...
            lr_predictor=lr_predictor, lr_hmc=lr_hmc, lr_scale=lr_scale, update_s_each=update_s_each
        )
        ...
        self.variance = nn.Parameter(torch.ones(dim_x)*variance)
